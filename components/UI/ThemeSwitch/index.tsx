...
type ThemeSwitcherProps = {
    theme: string;
    setTheme: React.Dispatch<React.SetStateAction<string>> & React.ChangeEventHandler<HTMLInputElement>;
};
    ...
    return (
        <div className="mt-auto flex min-h-[4.8rem] w-full items-center justify-center rounded-md bg-grey-light dark:bg-grey-very-dark tablet:mb-[-4rem]">
            ...
            <label
                ...
                htmlFor="themeSwitch"
            >
                <input className="hidden" type="checkbox" id="themeSwitch" onChange={setTheme} />
                <div
