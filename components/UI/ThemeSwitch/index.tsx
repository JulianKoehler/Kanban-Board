    ...
    return (
        <div className="mt-auto flex min-h-[4.8rem] w-full items-center justify-center rounded-md bg-grey-light dark:bg-grey-very-dark tablet:mb-[-4rem]">
            ...
            <label
                ...
                <div
                    className={cn(
                        isDarkMode ? 'translate-x-[2.3rem]' : 'translate-x-[0.3rem]',
                        'relative transition-transform duration-[400ms] ease-in-out before:absolute before:top-[0.3rem] before:flex before:h-[1.4rem] before:w-[1.4rem] before:rounded-full before:bg-white before:content-[""]',
                    )}
                />
            </label>
