...
const Sidebar = ({
  ...
  return (
    <aside
      ...
      } relative flex h-screen flex-col gap-[5.4rem] border-r border-lines-light bg-white py-12 pl-[2.4rem] transition-margin duration-300 dark:border-lines-dark dark:bg-grey-dark`}
    >
